...
OBJS=amazon.o user.o db_parser.o product.o product_parser.o util.o armanids.o book.o clothing.o movie.o
...
armanids.o: armanids.cpp armanids.h datastore.h product.h user.h util.h 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c armanids.cpp 
...
clothing.o: clothing.cpp book.h product.h util.h 
